...
TOOL_HANDLERS = {
    ...
    "background_run":   lambda **kw: "Error: Manager not available",
    "check_background": lambda **kw: "Error: Manager not available",
    "task_create":      lambda **kw: "Error: Manager not available",
    ...
    "read_inbox":       lambda **kw: "Error: Manager not available",
